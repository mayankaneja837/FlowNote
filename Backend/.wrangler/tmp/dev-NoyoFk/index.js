  ...
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    C.cubeRoot = C.cbrt = function() {
      ...
      for (N = false, o = g.s * W(g.s * g, 1 / 3), !o || Math.abs(o) == 1 / 0 ? (r = z2(g.d), e = g.e, (o = (e - r.length + 1) % 3) && (r += o == 1 || o == -2 ? "0" : "00"), o = W(r, 1 / 3), e = X((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2)), o == 1 / 0 ? r = "5e" + e : (r = o.toExponential(), r = r.slice(0, r.indexOf("e") + 1) + e), n = new h(r), n.s = g.s) : n = new h(o.toString()), s = (e = h.precision) + 3; ; )
        if (a = n, l = a.times(a).times(a), f = l.plus(g), n = q(f.plus(g).times(a), f.plus(l), s + 2, 1), z2(a.d).slice(0, s) === (r = z2(n.d)).slice(0, s))
    ...
    C.squareRoot = C.sqrt = function() {
      ...
      for (N = false, f = Math.sqrt(+s), f == 0 || f == 1 / 0 ? (t = z2(a), (t.length + l) % 2 == 0 && (t += "0"), f = Math.sqrt(t), l = X((l + 1) / 2) - (l < 0 || l % 2), f == 1 / 0 ? t = "5e" + l : (t = f.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + l), n = new g(t)) : n = new g(f.toString()), r = (l = g.precision) + 3; ; )
        if (o = n, n = o.plus(q(s, o, r + 2, 1)).times(0.5), z2(o.d).slice(0, r) === (t = z2(n.d)).slice(0, r))
    ...
    C.toFraction = function(e) {
      ...
      for (N = false, a = new A(z2(R)), g = A.precision, A.precision = o = R.length * O * 2; h = q(a, t, 0, 1, 1), i = r.plus(h.times(n)), i.cmp(e) != 1; )
    ...
    C.toPower = C.pow = function(e) {
      ...
      return r = W(+a, f), t = r == 0 || !isFinite(r) ? X(f * (Math.log("0." + z2(a.d)) / Math.LN10 + a.e + 1)) : new l(r + "").e, t > l.maxE + 1 || t < l.minE - 1 ? new l(t > 0 ? s / 0 : 0) : (N = false, l.rounding = a.s = 1, r = Math.min(12, (t + "").length), i = Cn(e.times(Oe(a, n + r)), n), i.d && (i = I(i, n + 5, 1), St(i.d, n, o) && (t = n + 10, i = I(Cn(e.times(Oe(a, t + r)), t), t + 5, 1), +z2(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = I(i, n + 1, 0)))), i.s = s, N = true, l.rounding = o, I(i, n, o));
    };
    ...
    function Cn(e, t) {
      ...
      for (n = Math.log(W(2, h)) / Math.LN10 * 2 + 5 | 0, l += n, r = o = s = new v(1), v.precision = l; ; ) {
        if (o = I(o.times(e), l, 1), r = r.times(++g), a = s.plus(q(o, r, l, 1)), z2(a.d).slice(0, l) === z2(s.d).slice(0, l)) {
          for (i = h; i--; )
            s = I(s.times(s), l, 1);
          if (t == null)
    ...
    function Oe(e, t) {
      ...
      if (t == null ? (N = false, g = k) : g = t, M.precision = g += R, r = z2(D), n = r.charAt(0), Math.abs(o = A.e) < 15e14) {
      ...
      for (h = A, l = s = A = q(A.minus(1), A.plus(1), g, 1), v = I(A.times(A), g, 1), i = 3; ; ) {
        if (s = I(s.times(v), g, 1), f = l.plus(q(s, new M(i), g, 1)), z2(f.d).slice(0, g) === z2(l.d).slice(0, g))
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/mayankaneja/Cohort/FlowNote/Backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/mayankaneja/Cohort/FlowNote/Backend/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-rsv2RM/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-rsv2RM/middleware-insertion-facade.js
init_modules_watch_stub();
...
app.use("/api/v1/blog/*", async (c, next) => {
  ...
  const jwt2 = await verify2(token, c.env.JWT_SECRET);
  if (jwt2.id) {
    return c.json({
      message: "User exists"
    });
